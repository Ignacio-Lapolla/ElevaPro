...
@Singleton
class PreferenciasDataSource @Inject constructor(
    @ApplicationContext private val context: Context,
) {
    private val MODO_OSCURO = booleanPreferencesKey("modo_oscuro")

    val modoOscuro: Flow<Boolean> = context.dataStore.data.map { it[MODO_OSCURO] ?: false }

    suspend fun setModoOscuro(value: Boolean) {
